...
plugin_openid_auth_ver_17 = 1.0.2
...
plugin_ldap_auth_url = https://bitbucket.org/xnatx/ldap-auth-plugin/downloads/ldap-auth-plugin-${plugin_ldap_auth_ver}.jar
plugin_openid_auth_jar = openid-auth-plugin-$(plugin_openid_auth_ver).jar
plugin_openid_auth_url = https://nrgxnat.jfrog.io/artifactory/libs-snapshot/au/edu/qcif/xnat/openid/openid-auth-plugin/1.1.1-SNAPSHOT/openid-auth-plugin-1.1.1-SNAPSHOT-xpl.jar
plugin_openid_auth_url_17 = https://github.com/Australian-Imaging-Service/xnat-openid-auth-plugin/releases/download/$(plugin_openid_auth_ver)/xnat-openid-auth-plugin-all-$(plugin_openid_auth_ver).jar
